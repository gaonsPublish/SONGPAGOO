...
//  검색하러가기 버튼
	$('#second_search img:first-child').mouseenter(function(){
		$('#second_search img:last-child').css('display','block');
		$('#second_search img:first-child').css('display','none');
	});
	$('#second_search img:last-child').mouseleave(function(){
		$('#second_search img:first-child').css('display','block');
		$('#second_search img:last-child').css('display','none');
	});
